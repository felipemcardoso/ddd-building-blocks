...
import br.com.felipemcardoso.ddd.domain.common.EventType;
import br.com.felipemcardoso.ddd.domain.common.SimNao;
...
public class Event extends Entity<EventId> {
    ...
    private SimNao published;

    private String json;

    public Event(EventId key, Date data, EventType type, SimNao publicado, String json) {
        super(key);
        this.data = data;
        this.type = type;
    ...
    public static Event create(DomainEvent event) {
        ...
        return new Event(eventId, data, EventType.PUBLICADO, SimNao.NAO, json);
    }
    ...
    public static Event create(String json) {
        ...
        return new Event(eventId, data, EventType.CONSUMIDO, SimNao.NAO, json);
    }
